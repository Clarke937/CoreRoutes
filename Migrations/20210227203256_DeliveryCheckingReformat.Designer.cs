...
namespace CoreRoutes.Migrations
{
    ...
    [Migration("20210227203256_DeliveryCheckingReformat")]
    partial class DeliveryCheckingReformat
    {
            ...
            modelBuilder.Entity("CoreRoutes.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2021, 2, 27, 14, 32, 56, 359, DateTimeKind.Local).AddTicks(7768),
                            UpdateAt = new DateTime(2021, 2, 27, 14, 32, 56, 360, DateTimeKind.Local).AddTicks(5585),
                            UserRole = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreateAt = new DateTime(2021, 2, 27, 14, 32, 56, 360, DateTimeKind.Local).AddTicks(5874),
                            UpdateAt = new DateTime(2021, 2, 27, 14, 32, 56, 360, DateTimeKind.Local).AddTicks(5878),
                            UserRole = "Manager"
                        },
                        new
                        {
                            Id = 3,
                            CreateAt = new DateTime(2021, 2, 27, 14, 32, 56, 360, DateTimeKind.Local).AddTicks(5880),
                            UpdateAt = new DateTime(2021, 2, 27, 14, 32, 56, 360, DateTimeKind.Local).AddTicks(5881),
                            UserRole = "Driver"
                        });
                });
            ...
            modelBuilder.Entity("CoreRoutes.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2021, 2, 27, 14, 32, 56, 389, DateTimeKind.Local).AddTicks(4995),
                            Email = "eretana60@gmail.com",
                            Password = "$2a$06$v67KPrD.ZAyMIN5T86/3Bes9EZB4DSVWVQ9Fj41wqaj/VIJzeIVZG",
                            RoleFK = 1,
                            UpdateAt = new DateTime(2021, 2, 27, 14, 32, 56, 389, DateTimeKind.Local).AddTicks(5306),
                            Username = "eretana"
                        });
                });
