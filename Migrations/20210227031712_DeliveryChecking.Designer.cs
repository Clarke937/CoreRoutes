...
namespace CoreRoutes.Migrations
{
    ...
    [Migration("20210227031712_DeliveryChecking")]
    partial class DeliveryChecking
    {
            ...
            modelBuilder.Entity("CoreRoutes.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2021, 2, 26, 21, 17, 12, 386, DateTimeKind.Local).AddTicks(2913),
                            UpdateAt = new DateTime(2021, 2, 26, 21, 17, 12, 387, DateTimeKind.Local).AddTicks(691),
                            UserRole = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreateAt = new DateTime(2021, 2, 26, 21, 17, 12, 387, DateTimeKind.Local).AddTicks(989),
                            UpdateAt = new DateTime(2021, 2, 26, 21, 17, 12, 387, DateTimeKind.Local).AddTicks(993),
                            UserRole = "Manager"
                        },
                        new
                        {
                            Id = 3,
                            CreateAt = new DateTime(2021, 2, 26, 21, 17, 12, 387, DateTimeKind.Local).AddTicks(995),
                            UpdateAt = new DateTime(2021, 2, 26, 21, 17, 12, 387, DateTimeKind.Local).AddTicks(996),
                            UserRole = "Driver"
                        });
                });
            ...
            modelBuilder.Entity("CoreRoutes.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2021, 2, 26, 21, 17, 12, 416, DateTimeKind.Local).AddTicks(585),
                            Email = "eretana60@gmail.com",
                            Password = "$2a$06$WwEdkxluZR1GnGjVQ8k/vexfvzhmDtdeZmt25pT70caTWYDclZrrm",
                            RoleFK = 1,
                            UpdateAt = new DateTime(2021, 2, 26, 21, 17, 12, 416, DateTimeKind.Local).AddTicks(893),
                            Username = "eretana"
                        });
                });
            ...
            modelBuilder.Entity("CoreRoutes.Models.DeliveryChecking", b =>
                {
                    ...
                    b.HasOne("CoreRoutes.Models.Route", "Route")
                        .WithMany()
